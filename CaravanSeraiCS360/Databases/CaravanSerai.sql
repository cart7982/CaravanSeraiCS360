...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2025 at 08:58 PM
...
--
CREATE DATABASE IF NOT EXISTS `caravanserai` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `caravanserai`;
...
INSERT INTO `messages` (`UserID1`, `UserID2`, `BarterMessage`, `TransactionID`, `Amount1`, `MessageID`, `Amount2`, `ProductName1`, `ProductName2`) VALUES
(1, 2, 'My counteroffer is sharp', 29, 25, 11, 5, 'Tin Ingots', 'Wine'),
(4, 1, 'My carnelians for your iron', 33, 7, 12, 10, 'Uncut carnelian', 'Iron Ingots');
...
('Iron Ingots', 21, 1, 120, 'Very hard'),
('Tin Ingots', 22, 1, 200, 'For your casting needs!'),
('Bronze Ingots', 23, 1, 76, 'Pretty hard too!'),
('Uncut topaz', 24, 4, 45, 'Green'),
('Uncut carnelian', 25, 4, 30, 'Red'),
...
(29, 14, 0, 10, 0, 1, 2, 'Wine', ''),
(30, 18, 0, 6, 0, 2, 3, 'Pigs', ''),
(31, 20, 0, 50, 0, 2, 1, 'Copper Ingots', ''),
(32, 15, 0, 5, 0, 1, 2, 'Jewelry', ''),
(33, 21, 0, 10, 0, 4, 1, 'Iron Ingots', ''),
(34, 17, 0, 17, 0, 4, 3, 'Cows', '');
...
INSERT INTO `users` (`Username`, `Email`, `Password`, `Role`, `UserID`) VALUES
('aa', 'aa@aa', 'aa', '', 1),
('bb', 'bb@bb', 'bb', '', 2),
('cc', 'cc@cc', 'cc', '', 3),
('dd', 'dd@dd', 'dd', '', 4);
...
--
-- Database: `labassignment3`
--
CREATE DATABASE IF NOT EXISTS `labassignment3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `labassignment3`;
...
INSERT INTO `users` (`FirstName`, `LastName`, `Passwrd`, `Email`, `mem_id`) VALUES
('aa', 'aa', 'aa', 'aa@aa', 20),
('Bilbo', 'Baggins', 'ring', 'bilbastic@shire.com', 22),
('Frodo', 'Baggins', 'myring', 'frodinator@shire.com', 23),
('Meriadoc', 'Brandybuck', 'pipeweed', 'pints@shire.com', 25),
('Peregrine', 'Took', 'secondbreakfast', 'pippins@shire.com', 26);
--
-- Database: `openplaza`
--
CREATE DATABASE IF NOT EXISTS `openplaza` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `openplaza`;
...
INSERT INTO `transactions` (`TransactionID`, `ProductName`, `ProductID`, `UserID`, `Quantity`, `TotalPrice`, `Price`) VALUES
(15, 'gg', 10, 3, 1, 88, 88),
(17, 'ww', 12, 3, 2, 22, 11),
(20, 'vv', 8, 2, 4, 308, 77),
(25, 'gg', 10, 4, 1, 88, 88),
...
(34, 'gg', 9, 1, 2, 88, 44),
(35, 'ee', 11, 1, 3, 270, 90),
(36, 'pp', 14, 2, 11, 605, 55),
(37, 'rr', 15, 2, 11, 726, 66);
...
INSERT INTO `users` (`Username`, `Email`, `Password`, `Role`, `UserID`, `ProductID`) VALUES
('aa', 'aa@aa', 'aa', '', 1, 0),
('bb', 'bb@bb', 'bb', '', 2, 0),
('cc', 'cc@cc', 'cc', '', 3, 0),
('dd', 'dd@dd', 'dd', '', 4, 0);
...
('root', '[{\"db\":\"caravanserai\",\"table\":\"products\"},{\"db\":\"caravanserai\",\"table\":\"messages\"},{\"db\":\"caravanserai\",\"table\":\"transactions\"},{\"db\":\"caravanserai\",\"table\":\"users\"},{\"db\":\"caravanserai\",\"table\":\"aaa\"},{\"db\":\"caravanserai\",\"table\":\"groups\"},{\"db\":\"caravanserai\",\"table\":\"bbb\"},{\"db\":\"caravanserai\",\"table\":\"ccc\"},{\"db\":\"caravanserai\",\"table\":\"countermessage\"},{\"db\":\"openplaza\",\"table\":\"users\"}]');
...
('root', 'classicmodels', 'customers', '{\"sorted_col\":\"`customers`.`state` DESC\"}', '2025-03-03 22:33:35');
...
('root', '2025-03-18 19:58:02', '{\"Console\\/Mode\":\"collapse\"}');
